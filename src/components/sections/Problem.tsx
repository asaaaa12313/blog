...
export default function Problem() {
    ...
    return (
        <section ref={containerRef} className="flex min-h-fit flex-col items-center justify-center bg-background px-4 py-12">
            <motion.div
                style={{ opacity }}
            ...
            <div className="relative h-16 w-full max-w-2xl overflow-visible">
                <svg
                    viewBox="0 0 300 100"
                    fill="none"
            ...
            <motion.div
                ...
                className="mt-8 max-w-3xl text-center space-y-8"
            >
                <p className="text-lg leading-relaxed text-black md:text-xl font-medium">
                ...
                <p className="text-xl font-bold leading-relaxed text-blue-800 md:text-2xl bg-blue-100 py-6 px-8 rounded-2xl inline-block shadow-sm">
